...
namespace LMS.UI.Controllers
{
    ...
    public class CourseCompletionsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.Count = courseCompletions.Where(x => x.UserId == userId).ToList().Count();
            return View(courseCompletions.Where(x => x.UserId == userId).ToList());
        ...
        public ActionResult Create([Bind(Include = "CourseCompletionId,CourseId,DateCompleted,UserId")] CourseCompletion courseCompletion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CourseCompletionId,CourseId,DateCompleted,UserId")] CourseCompletion courseCompletion)
        {
            if (ModelState.IsValid)
            {
